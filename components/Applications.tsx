...
const spaces = [
  { title: "욕실 & 화장실", tags: ["세면대 하부", "욕실 수납장", "욕실벽체"], desc: "물이 튀는 환경에서도 완벽히 안전합니다.", image: "/images/욕실화장실.jpg" },
  ...
  { title: "야외 & 베란다", tags: ["베란다", "테라스", "캠핑장"],   desc: "UV 코팅으로 야외 사용도 가능합니다.",        image: "/images/베란다.jpg" },
